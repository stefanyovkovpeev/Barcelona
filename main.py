...
clubs_frame = tkinter.Frame(root, width=1400, height=700)
...
day1_frame = Frame(root)
day2_frame = Frame(root)
day3_frame = Frame(root)
day4_frame = Frame(root)
...
def enter_nav(event, location):
    event.widget.config(relief=tkinter.SUNKEN)
    test = loc_dict[desttonav_dict[location]]
