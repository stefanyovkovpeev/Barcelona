This is an app I made when I went to Barcelona.At first it was built like a game for my family. But I decided to expand on it and make it a project to test out my coding skills so far.
It is a desktop app.
It has an .exe file inside made with pyinstaller in the repository,called LAUNCHER, so it will run without anything preinstalled.
...
Има .exe файл в хранилището направен с pyinstaller с името LAUNCHER, така че ще работи без нищо предварително инсталирано.
